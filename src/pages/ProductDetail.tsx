...
import { ArrowLeft, Truck, RotateCcw, Shield, Minus, Plus, Heart, ShoppingCart } from 'lucide-react';
                    ...
                    <div className="flex space-x-2 mt-4">
                      {product.images.map((image, idx) => (
                        <button 
                          ...
                          className={`w-16 h-16 rounded bg-white flex items-center justify-center ${
                            selectedImage === idx ? 'ring-2 ring-brand' : 'ring-1 ring-neutral-200'
                          }`}
                        >
                          <img 
                            src={image} 
                  ...
                  <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {product.sizes.map(size => (
                          <button
                            ...
                            className={`px-3 py-2 border rounded-md min-w-[3rem] transition-colors ${
                              selectedSize === size 
                    ...
                    <div className="pt-6 flex flex-col sm:flex-row gap-4">
                      <Button 
                        ...
                        className="flex-1 bg-neutral-800 hover:bg-black text-white"
                        size="lg"
                      >
